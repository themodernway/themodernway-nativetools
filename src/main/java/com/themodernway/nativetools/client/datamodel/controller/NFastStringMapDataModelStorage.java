...
{
    private final NFastStringMap<T>    m_storage = new NFastStringMap<T>();

    private final String               m_name;

    private final Function<NObject, T> m_builder;

    public NFastStringMapDataModelStorage(final String name, final Function<NObject, T> builder)
    {
    ...
    @Override
    public final Collection<T> get(final ModelIDList list)
    {
    ...
    @Override
    public final void remove(final ModelIDList list)
    {
        final int size = list.size();
