...
public class NFastBooleanDictionaryJSO extends NFastPrimitiveDictionarytBaseJSO<NFastBooleanDictionaryJSO>
{
    public static final NFastBooleanDictionaryJSO make()
    {
        return createNObjectBaseJSO();
    }

    protected NFastBooleanDictionaryJSO()
    {
    }
    ...
    private final native boolean get_0(String name)
    /*-{
		return this[name];
    }-*/;
}
